      ...
      <div class="overview">
        ...
        <ul class="remark">
          <li class="block">
            <h2>起送价</h2>
            <div class="content">
              <span class="stree">{{seller.minPrice}}</span>元
            </div>
          </li>
          <li class="block">
            <h2>商家配送</h2>
            <div class="content">
              <span class="stree">{{seller.deliveryPrice}}</span>元
            </div>
          </li>
          <li class="block">
            <h2>平均配送时间</h2>
            <div class="content">
              <span class="stree">{{seller.deliveryTime}}</span>分钟
            </div>
          </li>
        </ul>
        <div class="favorite" @click="toggleFavorite">
          <i class="ift-favorite" :class="{active:favorite}"></i>
...
export default {
  ...
  data() {
    return {
      favorite: (() => {
        return unit.loadFromLocal(this.seller.id, 'favorite', false);
      })()
    };
  },
  computed: {
  ...
  methods: {
    ...
    toggleFavorite(event) {
      ...
      unit.saveToLoacal(this.seller.id, 'favorite', this.favorite);
    }
  },
  components: {
    star,
